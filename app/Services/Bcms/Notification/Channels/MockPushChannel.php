...
/**
 * The Phase 0 mock for Push. Replaced by the real adapter in Phase 7, which
 ...
 */
final class MockPushChannel extends MockChannel
{
    public function __construct(int $failEvery = 0)
    {
        parent::__construct(ChannelKey::Push, $failEvery);
    }
}
