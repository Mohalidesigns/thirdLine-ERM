...
/**
 * @extends Factory<ExerciseDefinition>
 *
...
{
    protected $model = ExerciseDefinition::class;
    ...
    public function definition(): array
    {
        return [
            ...
            'exercise_programme_id' => \App\Models\Bcms\ExerciseProgramme::factory(),
            'exercise_type_id' => \App\Models\Bcms\ExerciseType::factory(),
