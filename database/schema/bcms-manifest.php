...
return [
    ...
    'bcms_bia_assessments' => [
        'ai_drafted_at', 'ai_generated', 'approved_at', 'approved_by', 'assessor_id',
        'campaign_id', 'created_at', 'created_by', 'deleted_at', 'id', 'iso_clause_ref',
        'mbco_description', 'min_staff_required', 'mtpd_hours', 'organization_id', 'peak_periods',
        'process_id', 'rpo_minutes', 'rto_hours', 'status', 'submitted_at', 'updated_at',
        'updated_by', 'uuid', 'workaround_available', 'workaround_max_duration_hours'
    ],
    'bcms_bia_campaigns' => [
    ...
    'bcms_exercise_definitions' => [
        ...
        'facilitator_id', 'frequency_per_year', 'id', 'iso_clause_ref', 'lead_time_days',
        'mandatory', 'min_notice_days', 'name', 'objectives', 'organization_id', 'owner_id',
        'preferred_window', 'process_ids', 'readiness_gating', 'regulatory_drivers',
    ...
    'bcms_findings' => [
        ...
        'incident_id', 'iso_clause_ref', 'organization_id', 'raised_at', 'raised_by', 'reference',
        'root_cause', 'severity', 'status', 'updated_at', 'updated_by', 'uuid'
    ],
    'bcms_incident_log' => [
    ...
    'bcms_objectives' => [
        'created_at', 'created_by', 'deleted_at', 'description', 'id', 'iso_clause_ref',
        'key_risk_indicator_id', 'measure_description', 'organization_id', 'owner_id',
        'programme_id', 'status', 'target_date', 'target_unit', 'target_value', 'title',
    ...
    'bcms_processes' => [
        ...
        'criticality_tier', 'deleted_at', 'description', 'id', 'is_critical_service',
        'iso_clause_ref', 'name', 'organization_id', 'owner_id', 'parent_process_id',
        'regulatory_flags', 'status', 'updated_at', 'updated_by', 'uuid'
    ],
    'bcms_programmes' => [
        'approved_at', 'approved_by', 'board_attested_at', 'board_attested_by', 'created_at',
        'created_by', 'deleted_at', 'id', 'iso_clause_ref', 'name', 'organization_id',
        'out_of_scope_statement', 'owner_id', 'policy_document_id', 'scope_statement', 'status',
        'updated_at', 'updated_by', 'uuid', 'year'
    ],
    ...
    'bcms_settings' => [
        ...
        'created_at', 'created_by', 'default_channel_set', 'default_lead_time_days',
        'default_reminder_mode', 'escalation_day_offset', 'exercise_simulation_default', 'id',
        'life_safety_channel_set', 'organization_id', 'quiet_hours_end', 'quiet_hours_start',
        'reminder_send_time', 'require_dual_approval_for_live', 'timezone', 'updated_at',
        'updated_by'
    ],
    'bcms_sites' => [
