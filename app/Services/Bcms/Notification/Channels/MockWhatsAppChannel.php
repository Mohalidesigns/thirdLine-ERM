...
/**
 * The Phase 0 mock for WhatsApp. Replaced by the real adapter in Phase 7, which
 ...
 */
final class MockWhatsAppChannel extends MockChannel
{
    public function __construct(int $failEvery = 0)
    {
        parent::__construct(ChannelKey::WhatsApp, $failEvery);
    }
}
