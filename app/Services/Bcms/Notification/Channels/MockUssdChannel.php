...
/**
 * The Phase 0 mock for Ussd. Replaced by the real adapter in Phase 7, which
 ...
 */
final class MockUssdChannel extends MockChannel
{
    public function __construct(int $failEvery = 0)
    {
        parent::__construct(ChannelKey::Ussd, $failEvery);
    }
}
