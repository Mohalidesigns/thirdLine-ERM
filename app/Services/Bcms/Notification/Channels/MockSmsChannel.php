...
/**
 * The Phase 0 mock for Sms. Replaced by the real adapter in Phase 7, which
 ...
 */
final class MockSmsChannel extends MockChannel
{
    public function __construct(int $failEvery = 0)
    {
        parent::__construct(ChannelKey::Sms, $failEvery);
    }
}
