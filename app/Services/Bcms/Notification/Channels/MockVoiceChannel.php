...
/**
 * The Phase 0 mock for Voice. Replaced by the real adapter in Phase 7, which
 ...
 */
final class MockVoiceChannel extends MockChannel
{
    public function __construct(int $failEvery = 0)
    {
        parent::__construct(ChannelKey::Voice, $failEvery);
    }
}
