...
/**
 * The Phase 0 mock for Teams. Replaced by the real adapter in Phase 7, which
 ...
 */
final class MockTeamsChannel extends MockChannel
{
    public function __construct(int $failEvery = 0)
    {
        parent::__construct(ChannelKey::Teams, $failEvery);
    }
}
