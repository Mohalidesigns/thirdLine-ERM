...
/**
 * The Phase 0 mock for Slack. Replaced by the real adapter in Phase 7, which
 ...
 */
final class MockSlackChannel extends MockChannel
{
    public function __construct(int $failEvery = 0)
    {
        parent::__construct(ChannelKey::Slack, $failEvery);
    }
}
