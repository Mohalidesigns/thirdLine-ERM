...
Merged into the integration line on 2026-09-09; this used to be the root `CLAUDE.md` of the
`riskerm-wt/bcms` worktree, which no longer exists. The database gap that closed this document
now lives in the root `CLAUDE.md`, where it applies to all four modules.
