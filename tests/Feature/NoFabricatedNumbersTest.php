...
class NoFabricatedNumbersTest extends TestCase
{
    ...
    private const RNG_ALLOWLIST = [
        ...
        /*
         * The vendor portal's emailed sign-in code — TPRM Phase 8.
         *
         * THE OPPOSITE OF THE MONTE CARLO CASE, and this rule's advice is
         * exactly wrong for it. That entry is allowed because its randomness is
         * SEEDED AND REPRODUCIBLE; this one is allowed because its randomness
         * must never be either. A six-digit second factor generated by a
         * seeded, replayable generator is not a second factor.
         *
         * It is also not a figure. Nothing here reaches a screen as a number
         * anybody reasons about — the code is a credential, it is hashed
         * before it is stored, and it is dead ten minutes later. The rule
